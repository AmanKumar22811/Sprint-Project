...
class CustomerApiTest {
    ...
    void searchByCountry_returns200() throws Exception {
        mockMvc.perform(
                get("/api/customers/search/findByCountry")
    ...
    void searchByCustomerNameContaining_returns200() throws Exception {
        mockMvc.perform(
                get("/api/customers/search/findByCustomerNameContaining")
                .param("name","Auto")
        )
        .andExpect(status().isOk())
        .andExpect(jsonPath("$._embedded.customers").isArray());
    ...
    @Test
    @Order(12)
    void createCustomer_duplicateId_returns201_currentBehavior() throws Exception {
    ...
    @Test
    @Order(20)
    void patchCustomer_phone_returns204() throws Exception {
        ...
        mockMvc.perform(
            patch("/api/customers/" + TEST_CUST_NUM)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @Order(21)
    void patchCustomer_creditLimit_returns204() throws Exception {
